...
import com.letv.leui.common.recommend.volley.*;
...
public class VolleyClient {
    ...
    public static ImageLoader.ImageContainer loadImage(VolleyController vc, String url, ImageLoader.ImageListener imageListener) {
        Uri.Builder uri = Uri.parse(url).buildUpon().appendQueryParameter("mltag", Integer.toString(1));
        ImageLoader imageLoader = vc.getImageLoader();
        return imageLoader.get(uri.toString(), imageListener);
    }
