...
public interface HttpManager {
     ...
     * @throws Throwable
     */
    <T> T getSync(RequestParams entity, Type resultType) throws Throwable;
     ...
     * @throws Throwable
     */
    <T> T postSync(RequestParams entity, Type resultType) throws Throwable;
     ...
     * @throws Throwable
     */
    <T> T requestSync(HttpMethod method, RequestParams entity, Type resultType) throws Throwable;
