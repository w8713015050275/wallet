...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private String getLastUpdateTime() {
        ...
        if (seconds < 60) {
            sb.append(seconds + getResources().getQuantityString(R.plurals.cube_ptr_seconds_ago, seconds));
        } else {
            ...
            if (minutes > 60) {
                ...
                if (hours > 24) {
                    ...
                    sb.append(hours + getContext().getResources().getQuantityString(R.plurals.cube_ptr_hours_ago, hours));
                }

            } else {
                sb.append(minutes + getContext().getResources().getQuantityString(R.plurals.cube_ptr_minutes_ago, minutes));
            }
        }
        return sb.toString();
    }
