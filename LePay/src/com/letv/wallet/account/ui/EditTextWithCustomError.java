...
public class EditTextWithCustomError extends EditText {
    ...
    public EditTextWithCustomError(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, android.R.attr.editTextStyle, 0);
    }

    public EditTextWithCustomError(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mErrorIcon == null) {
            mErrorIcon = getResources().getDrawable(R.drawable.edit_error_icon, getContext().getTheme());
        }
        ...
        if (mErrorBackground == null) {
            mErrorBackground = getResources().getDrawable(R.drawable.popup_inline_error_am, getContext().getTheme());
        }
        ...
        if (mErrorBackgroundAbove == null) {
           // mErrorBackgroundAbove = getResources().getDrawable(R.drawable.popup_inline_error_above_am, getContext().getTheme());
        }
...
//			LayoutInflater inflater = LayoutInflater.from(getContext());
            ...
            err.setTextColor(mErrorTextColor == 0 ? Color.WHITE : mErrorTextColor);
